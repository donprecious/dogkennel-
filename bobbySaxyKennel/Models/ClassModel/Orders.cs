...
namespace bobbySaxyKennel.Models.ClassModel
{
    public class Orders
    {
        ...
        public bool Add(int customerId, int petId, string deliveryAddress, string contact, int quantity, double totalPrice, int? toppingId, string size, string note, string optionDetail="", DateTime? pickupDateTime=null, decimal? lat=null, decimal? log =null )
        {
            try
            {
